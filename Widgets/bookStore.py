"""
Program that stores the book information:
Title, Author,
Year, ISBN
...
Package both the programs in an single executable file
ex: bookFrontend.exe

TODO: for generating a executable file
install pyinstaller
python -m pip install pyinstaller
run command:
pyinstaller --onefile --windowed bookFrontend.py
"""
from tkinter import *
import bookBackend
